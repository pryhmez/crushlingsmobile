                    ...
                    <View style={{ marginTop: 25, marginBottom: 25, flex: 1, backgroundColor: 'transparent', flexDirection: 'row' }}>
                        <View style={{ backgroundColor: 'transparent', flex: 1, justifyContent: 'space-around', alignItems: 'center' }}>
                            <Image
                                ...
                                style={{ width: hp('30%') / 2.3, height: hp('30%') / 2.3, borderRadius: hp('30%') / 4, padding: 10, backgroundColor: 'yellow' }} />
                        </View>
                        <View style={{ backgroundColor: 'tranparent', flex: 2.5, justifyContent: 'space-around' }}>
                            <View style={{ height: '80%', marginBottom: 10, marginTop: 10, backgroundColor: 'transparent' }}>
                                <View style={{ flex: 1 }}>
                                    <Text style={{ color: '#fff', fontSize: 24, marginTop: 0, fontWeight: '100' }}>Prime Isaac</Text>
                                    <Text style={{ color: '#363636', fontSize: 13, textAlignVertical: 'top', padding: 0 }}>@prime_Isaac</Text>
                                </View>
                                <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>

                                    <TouchableOpacity style={styles.Stats}>
                                        <Text style={{ color: '#fff', fontSize: 20, marginTop: 0, fontWeight: '100' }}>120K</Text>
                                        <Text style={{ color: '#363636', fontSize: 13, marginTop: 0 }}>friends</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={styles.Stats}>
                                        <Text style={{ color: '#fff', fontSize: 20, marginTop: 0, fontWeight: '100' }}>20K</Text>
                                        <Text style={{ color: '#363636', fontSize: 13, marginTop: 0 }}>Crushes</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={styles.Stats}>
                                        <Text style={{ color: '#fff', fontSize: 20, marginTop: 0, fontWeight: '100' }}>130K</Text>
